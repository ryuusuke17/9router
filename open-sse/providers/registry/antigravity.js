...
export default {
  ...
  models: [
    ...
    { id: "gemini-3.5-flash-extra-low", name: "Gemini 3.5 Flash (Lowest)" },
    { id: "gemini-pro-agent", name: "Gemini 3.1 Pro (Agent)" },
    { id: "gemini-3-pro-preview", name: "Gemini 3.1 Pro" },
    ...
    { id: "gemini-3-pro-image-preview", name: "Gemini 3 Pro Image", kind: "image", imageGen: true, capabilities: ["textToImage"] },
  ],
  oauth: {
